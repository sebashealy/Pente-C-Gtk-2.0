...
void mostrar_ganadores(GtkWidget *widget, gpointer data);
extern void pantalla_juego(GtkWidget *widget, gpointer data);

void pantalla_ganador(GtkWidget *widget, char letra)
{
  ...
  g_signal_connect(G_OBJECT(abrir_info), "clicked", G_CALLBACK(mostrar_ganadores), ventana);
